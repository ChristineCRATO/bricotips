...
<main id="apropos">
	...
	<?php
		echo do_shortcode('[banniere-titre titre="À propos de BricoTips" src="http://localhost:8888/bricotips/wp-content/uploads/2024/01/banniere-image.webp"]');
	?>
    ...
    <section id="quisuisje">
        ...
        <div class="image">
            <img src="<?= get_stylesheet_directory_uri()."/images/a-propos/autor.jpg" ?>">
        </div>
    </section>
    <section id="bricolage">
        <h2>Notre passion commune</h2>
        <div class="image">
            <img src="<?= get_stylesheet_directory_uri()."/images/a-propos/brico.jpg" ?>">
        </div>
        <div class="text">
